...
#define __PYX_HAVE__implicit___nearest_neighbours
#define __PYX_HAVE_API__implicit___nearest_neighbours
#include <string.h>
#include <stdlib.h>
#include <vector>
#include "ios"
...
/* Module declarations from 'implicit._nearest_neighbours' */
...
#define __Pyx_MODULE_NAME "implicit._nearest_neighbours"
int __pyx_module_is_main_implicit___nearest_neighbours = 0;

/* Implementation of 'implicit._nearest_neighbours' */
...
static const char __pyx_k_heap_order[] = "heap_order";
static const char __pyx_k_item_count[] = "item_count";
static const char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_item_indptr[] = "item_indptr";
static const char __pyx_k_user_indptr[] = "user_indptr";
...
static const char __pyx_k_implicit__nearest_neighbours[] = "implicit._nearest_neighbours";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static const char __pyx_k_Users_ben_code_implicit_implici[] = "/Users/ben/code/implicit/implicit/_nearest_neighbours.pyx";
...
static PyObject *__pyx_kp_s_Users_ben_code_implicit_implici;
static PyObject *__pyx_n_s_ValueError;
static PyObject *__pyx_n_s_all_pairs_knn;
...
static PyObject *__pyx_n_s_heap_order;
static PyObject *__pyx_n_s_i;
static PyObject *__pyx_n_s_id;
static PyObject *__pyx_n_s_implicit__nearest_neighbours;
...
static PyObject *__pyx_n_s_item_indptr;
...
static PyObject *__pyx_n_s_user_indptr;
...
static PyObject *__pyx_pf_8implicit_19_nearest_neighbours_all_pairs_knn(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_items, int __pyx_v_K); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_8implicit_19_nearest_neighbours_1all_pairs_knn(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8implicit_19_nearest_neighbours_all_pairs_knn[] = " Returns the top K nearest neighbours for each row in the matrix ";
static PyMethodDef __pyx_mdef_8implicit_19_nearest_neighbours_1all_pairs_knn = {"all_pairs_knn", (PyCFunction)__pyx_pw_8implicit_19_nearest_neighbours_1all_pairs_knn, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8implicit_19_nearest_neighbours_all_pairs_knn};
static PyObject *__pyx_pw_8implicit_19_nearest_neighbours_1all_pairs_knn(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("all_pairs_knn (wrapper)", 0);
  {
    ...
    if (values[1]) {
      __pyx_v_K = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_K == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    } else {
      __pyx_v_K = ((int)0x64);
    }
  }
  ...
  __Pyx_RaiseArgtupleInvalid("all_pairs_knn", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 24, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("implicit._nearest_neighbours.all_pairs_knn", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8implicit_19_nearest_neighbours_all_pairs_knn(__pyx_self, __pyx_v_items, __pyx_v_K);
...
static PyObject *__pyx_pf_8implicit_19_nearest_neighbours_all_pairs_knn(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_items, int __pyx_v_K) {
  PyObject *__pyx_v_users = NULL;
  __Pyx_memviewslice __pyx_v_item_indptr = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_item_indices = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_item_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_user_indptr = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_user_indices = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_user_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  double __pyx_v_w1;
  double __pyx_v_w2;
  std::vector<double>  __pyx_v_sums;
  std::vector<int>  __pyx_v_nonzeros;
  std::vector<std::pair<double,int> >  __pyx_v_results;
  std::greater<std::pair<double,int> >  __pyx_v_heap_order;
  std::pair<double,int>  __pyx_v_result;
  PyObject *__pyx_v_values = NULL;
  PyObject *__pyx_v_rows = NULL;
  PyObject *__pyx_v_cols = NULL;
  __Pyx_memviewslice __pyx_v__values = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v__rows = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v__cols = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_current;
  std::pair<double,int>  __pyx_v_it;
  ...
  int __pyx_t_24;
  int __pyx_t_25;
  std::vector<std::pair<double,int> > ::iterator __pyx_t_26;
  ...
  /* "implicit/_nearest_neighbours.pyx":26
 * def all_pairs_knn(items, int K=100):
 *     """ Returns the top K nearest neighbours for each row in the matrix """
 *     users = items.T.tocsr()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_items, __pyx_n_s_T); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_tocsr); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
  ...
  /* "implicit/_nearest_neighbours.pyx":28
 *     users = items.T.tocsr()
 * 
 *     cdef int[:] item_indptr = items.indptr, item_indices = items.indices             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_items, __pyx_n_s_indptr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_v_item_indptr = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_items, __pyx_n_s_indices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1);
  if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_item_indices = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "implicit/_nearest_neighbours.pyx":29
 * 
 *     cdef int[:] item_indptr = items.indptr, item_indices = items.indices
 *     cdef double[:] item_data = items.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_items, __pyx_n_s_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_item_data = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "implicit/_nearest_neighbours.pyx":31
 *     cdef double[:] item_data = items.data
 * 
 *     cdef int[:] user_indptr = users.indptr, user_indices = users.indices             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_users, __pyx_n_s_indptr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1);
  if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_user_indptr = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_users, __pyx_n_s_indices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1);
  if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_user_indices = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "implicit/_nearest_neighbours.pyx":32
 * 
 *     cdef int[:] user_indptr = users.indptr, user_indices = users.indices
 *     cdef double[:] user_data = users.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_users, __pyx_n_s_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1);
  if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_user_data = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "implicit/_nearest_neighbours.pyx":34
 *     cdef double[:] user_data = users.data
 * 
 *     cdef int item_count = items.shape[0]             # <<<<<<<<<<<<<<
 ...
 *     cdef double w1, w2
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_items, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "implicit/_nearest_neighbours.pyx":45
 ...
 */
  try {
    __pyx_v_nonzeros.resize(__pyx_v_item_count, -1);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 45, __pyx_L1_error)
  }

  /* "implicit/_nearest_neighbours.pyx":46
 * 
 *     nonzeros.resize(item_count, -1)
 *     sums.resize(item_count, 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  try {
    __pyx_v_sums.resize(__pyx_v_item_count, 0.0);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 46, __pyx_L1_error)
  }

  /* "implicit/_nearest_neighbours.pyx":51
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_item_count * __pyx_v_K)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_7 = NULL;
  ...
  /* "implicit/_nearest_neighbours.pyx":52
 * 
 *     values = np.zeros(item_count * K)
 *     rows = np.zeros(item_count * K, dtype=int)             # <<<<<<<<<<<<<<
 *     cols = np.zeros(item_count * K, dtype=int)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int((__pyx_v_item_count * __pyx_v_K)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, ((PyObject *)(&PyInt_Type))) < 0) __PYX_ERR(0, 52, __pyx_L1_error)
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_8, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "implicit/_nearest_neighbours.pyx":53
 *     values = np.zeros(item_count * K)
 *     rows = np.zeros(item_count * K, dtype=int)
 *     cols = np.zeros(item_count * K, dtype=int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_item_count * __pyx_v_K)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_8, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "implicit/_nearest_neighbours.pyx":55
 *     cols = np.zeros(item_count * K, dtype=int)
 * 
 *     cdef double[:] _values = values             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_values);
  if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 55, __pyx_L1_error)
  __pyx_v__values = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "implicit/_nearest_neighbours.pyx":56
 * 
 *     cdef double[:] _values = values
 *     cdef long[:] _rows = rows             # <<<<<<<<<<<<<<
 *     cdef long[:] _cols = cols
 *     cdef int current = 0
 */
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_v_rows);
  if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 56, __pyx_L1_error)
  __pyx_v__rows = __pyx_t_9;
  __pyx_t_9.memview = NULL;
  __pyx_t_9.data = NULL;

  /* "implicit/_nearest_neighbours.pyx":57
 *     cdef double[:] _values = values
 *     cdef long[:] _rows = rows
 *     cdef long[:] _cols = cols             # <<<<<<<<<<<<<<
 *     cdef int current = 0
 * 
 */
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_v_cols);
  if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 57, __pyx_L1_error)
  __pyx_v__cols = __pyx_t_9;
  __pyx_t_9.memview = NULL;
  __pyx_t_9.data = NULL;
 ...
 */
  ...
  /* "implicit/_nearest_neighbours.pyx":60
 *     cdef int current = 0
 * 
 *     for i in range(item_count):             # <<<<<<<<<<<<<<
 *         head = -2
 ...
 */
    ...
    /* "implicit/_nearest_neighbours.pyx":64
 *         length = 0
 * 
 *         for index1 in range(item_indptr[i], item_indptr[i+1]):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_item_indptr.shape[0];
    __pyx_t_12 = (*((int *) ( /* dim=0 */ (__pyx_v_item_indptr.data + __pyx_t_11 * __pyx_v_item_indptr.strides[0]) )));
    __pyx_t_13 = __pyx_v_i;
    if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_v_item_indptr.shape[0];
    for (__pyx_t_14 = (*((int *) ( /* dim=0 */ (__pyx_v_item_indptr.data + __pyx_t_13 * __pyx_v_item_indptr.strides[0]) ))); __pyx_t_14 < __pyx_t_12; __pyx_t_14+=1) {
      __pyx_v_index1 = __pyx_t_14;

      /* "implicit/_nearest_neighbours.pyx":65
 * 
 *         for index1 in range(item_indptr[i], item_indptr[i+1]):
 *             u = item_indices[index1]             # <<<<<<<<<<<<<<
 *             w1 = item_data[index1]
 ...
 */
      ...
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_item_indices.shape[0];
      __pyx_v_u = (*((int *) ( /* dim=0 */ (__pyx_v_item_indices.data + __pyx_t_15 * __pyx_v_item_indices.strides[0]) )));

      /* "implicit/_nearest_neighbours.pyx":66
 *         for index1 in range(item_indptr[i], item_indptr[i+1]):
 *             u = item_indices[index1]
 *             w1 = item_data[index1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_item_data.shape[0];
      __pyx_v_w1 = (*((double *) ( /* dim=0 */ (__pyx_v_item_data.data + __pyx_t_16 * __pyx_v_item_data.strides[0]) )));

      /* "implicit/_nearest_neighbours.pyx":68
 *             w1 = item_data[index1]
 * 
 *             for index2 in range(user_indptr[u], user_indptr[u+1]):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_user_indptr.shape[0];
      __pyx_t_18 = (*((int *) ( /* dim=0 */ (__pyx_v_user_indptr.data + __pyx_t_17 * __pyx_v_user_indptr.strides[0]) )));
      __pyx_t_19 = __pyx_v_u;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_user_indptr.shape[0];
      for (__pyx_t_20 = (*((int *) ( /* dim=0 */ (__pyx_v_user_indptr.data + __pyx_t_19 * __pyx_v_user_indptr.strides[0]) ))); __pyx_t_20 < __pyx_t_18; __pyx_t_20+=1) {
        __pyx_v_index2 = __pyx_t_20;
 ...
 */
        ...
        if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_user_indices.shape[0];
        __pyx_v_j = (*((int *) ( /* dim=0 */ (__pyx_v_user_indices.data + __pyx_t_21 * __pyx_v_user_indices.strides[0]) )));
 ...
 */
        ...
        if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_user_data.shape[0];
        __pyx_v_w2 = (*((double *) ( /* dim=0 */ (__pyx_v_user_data.data + __pyx_t_22 * __pyx_v_user_data.strides[0]) )));
 ...
 */
        ...
        (__pyx_v_sums[__pyx_t_23]) = ((__pyx_v_sums[__pyx_t_23]) + (__pyx_v_w1 * __pyx_v_w2));

        /* "implicit/_nearest_neighbours.pyx":73
 *                 sums[j] += w1 * w2
 * 
 *                 if nonzeros[j] == -1:             # <<<<<<<<<<<<<<
 *                     nonzeros[j] = head
 *                     head = j
 */
        __pyx_t_24 = (((__pyx_v_nonzeros[__pyx_v_j]) == -1L) != 0);
        if (__pyx_t_24) {

          /* "implicit/_nearest_neighbours.pyx":74
 * 
 *                 if nonzeros[j] == -1:
 *                     nonzeros[j] = head             # <<<<<<<<<<<<<<
 *                     head = j
 *                     length += 1
 */
          (__pyx_v_nonzeros[__pyx_v_j]) = __pyx_v_head;

          /* "implicit/_nearest_neighbours.pyx":75
 *                 if nonzeros[j] == -1:
 *                     nonzeros[j] = head
 *                     head = j             # <<<<<<<<<<<<<<
 *                     length += 1
 * 
 */
          __pyx_v_head = __pyx_v_j;

          /* "implicit/_nearest_neighbours.pyx":76
 *                     nonzeros[j] = head
 *                     head = j
 *                     length += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "implicit/_nearest_neighbours.pyx":78
 *                     length += 1
 * 
 *         results.clear()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_12; __pyx_t_14+=1) {
      ...
      /* "implicit/_nearest_neighbours.pyx":81
 * 
 *         for index1 in range(length):
 *             w1 = sums[head]             # <<<<<<<<<<<<<<
 *             index2 = head
 * 
 */
      __pyx_v_w1 = (__pyx_v_sums[__pyx_v_head]);

      /* "implicit/_nearest_neighbours.pyx":82
 *         for index1 in range(length):
 *             w1 = sums[head]
 *             index2 = head             # <<<<<<<<<<<<<<
 * 
 *             head = nonzeros[head]
 */
      __pyx_v_index2 = __pyx_v_head;

      /* "implicit/_nearest_neighbours.pyx":84
 *             index2 = head
 * 
 *             head = nonzeros[head]             # <<<<<<<<<<<<<<
 * 
 *             sums[index2] = 0
 */
      __pyx_v_head = (__pyx_v_nonzeros[__pyx_v_head]);

      /* "implicit/_nearest_neighbours.pyx":86
 *             head = nonzeros[head]
 * 
 *             sums[index2] = 0             # <<<<<<<<<<<<<<
 *             nonzeros[index2] = -1
 * 
 */
      (__pyx_v_sums[__pyx_v_index2]) = 0.0;

      /* "implicit/_nearest_neighbours.pyx":87
 * 
 *             sums[index2] = 0
 *             nonzeros[index2] = -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      (__pyx_v_nonzeros[__pyx_v_index2]) = -1;

      /* "implicit/_nearest_neighbours.pyx":89
 *             nonzeros[index2] = -1
 * 
 *             if ((results.size() >= K) and             # <<<<<<<<<<<<<<
 *                     (w1 < results[0].first)):
 *                 continue
 */
      __pyx_t_25 = ((__pyx_v_results.size() >= __pyx_v_K) != 0);
      if (__pyx_t_25) {
      } else {
      ...
      /* "implicit/_nearest_neighbours.pyx":90
 * 
 *             if ((results.size() >= K) and
 *                     (w1 < results[0].first)):             # <<<<<<<<<<<<<<
 *                 continue
 * 
 */
      __pyx_t_25 = ((__pyx_v_w1 < (__pyx_v_results[0]).first) != 0);
      __pyx_t_24 = __pyx_t_25;
 ...
 */
      if (__pyx_t_24) {
        ...
        /* "implicit/_nearest_neighbours.pyx":91
 *             if ((results.size() >= K) and
 *                     (w1 < results[0].first)):
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "implicit/_nearest_neighbours.pyx":93
 *                 continue
 * 
 *             if results.size() >= K:             # <<<<<<<<<<<<<<
 ...
 *                 results.pop_back()
 */
      __pyx_t_24 = ((__pyx_v_results.size() >= __pyx_v_K) != 0);
      if (__pyx_t_24) {

        /* "implicit/_nearest_neighbours.pyx":94
 * 
 *             if results.size() >= K:
 *                 pop_heap(results.begin(), results.end(), heap_order)             # <<<<<<<<<<<<<<
 *                 results.pop_back()
 * 
 */
        std::pop_heap<std::vector<std::pair<double,int> > ::iterator,std::greater<std::pair<double,int> > >(__pyx_v_results.begin(), __pyx_v_results.end(), __pyx_v_heap_order);

        /* "implicit/_nearest_neighbours.pyx":95
 *             if results.size() >= K:
 *                 pop_heap(results.begin(), results.end(), heap_order)
 *                 results.pop_back()             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "implicit/_nearest_neighbours.pyx":97
 *                 results.pop_back()
 * 
 *             result.first = w1             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_v_result.first = __pyx_v_w1;

      /* "implicit/_nearest_neighbours.pyx":98
 * 
 *             result.first = w1
 *             result.second = index2             # <<<<<<<<<<<<<<
 *             results.push_back(result)
 ...
 */
      __pyx_v_result.second = __pyx_v_index2;

      /* "implicit/_nearest_neighbours.pyx":99
 *             result.first = w1
 *             result.second = index2
 *             results.push_back(result)             # <<<<<<<<<<<<<<
 *             push_heap(results.begin(), results.end(), heap_order)
 ...
 */
      ...
      /* "implicit/_nearest_neighbours.pyx":100
 *             result.second = index2
 *             results.push_back(result)
 *             push_heap(results.begin(), results.end(), heap_order)             # <<<<<<<<<<<<<<
 * 
 *         # TODO: gil?
 */
      std::push_heap<std::vector<std::pair<double,int> > ::iterator,std::greater<std::pair<double,int> > >(__pyx_v_results.begin(), __pyx_v_results.end(), __pyx_v_heap_order);
      __pyx_L10_continue:;
    }

    /* "implicit/_nearest_neighbours.pyx":103
 * 
 *         # TODO: gil?
 *         for it in results:             # <<<<<<<<<<<<<<
 *             _rows[current] = i
 ...
 */
    __pyx_t_26 = __pyx_v_results.begin();
    for (;;) {
      if (!(__pyx_t_26 != __pyx_v_results.end())) break;
      __pyx_t_27 = *__pyx_t_26;
      ++__pyx_t_26;
      __pyx_v_it = __pyx_t_27;

      /* "implicit/_nearest_neighbours.pyx":104
 *         # TODO: gil?
 *         for it in results:
 *             _rows[current] = i             # <<<<<<<<<<<<<<
 *             _cols[current] = it.second
 ...
 */
      __pyx_t_28 = __pyx_v_current;
      if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_v__rows.shape[0];
      *((long *) ( /* dim=0 */ (__pyx_v__rows.data + __pyx_t_28 * __pyx_v__rows.strides[0]) )) = __pyx_v_i;

      /* "implicit/_nearest_neighbours.pyx":105
 *         for it in results:
 *             _rows[current] = i
 *             _cols[current] = it.second             # <<<<<<<<<<<<<<
 *             _values[current] = it.first
 ...
 */
      ...
      __pyx_t_29 = __pyx_v_current;
      if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_v__cols.shape[0];
      *((long *) ( /* dim=0 */ (__pyx_v__cols.data + __pyx_t_29 * __pyx_v__cols.strides[0]) )) = __pyx_t_12;

      /* "implicit/_nearest_neighbours.pyx":106
 *             _rows[current] = i
 *             _cols[current] = it.second
 *             _values[current] = it.first             # <<<<<<<<<<<<<<
 *             current += 1
 * 
 */
      __pyx_t_30 = __pyx_v_it.first;
      __pyx_t_31 = __pyx_v_current;
      if (__pyx_t_31 < 0) __pyx_t_31 += __pyx_v__values.shape[0];
      *((double *) ( /* dim=0 */ (__pyx_v__values.data + __pyx_t_31 * __pyx_v__values.strides[0]) )) = __pyx_t_30;

      /* "implicit/_nearest_neighbours.pyx":107
 *             _cols[current] = it.second
 *             _values[current] = it.first
 *             current += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "implicit/_nearest_neighbours.pyx":109
 *             current += 1
 * 
 *     _rows = _cols = _values = None             # <<<<<<<<<<<<<<
 *     rows.resize(current)
 *     cols.resize(current)
 */
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(Py_None);
  ...
  if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 109, __pyx_L1_error)
  __PYX_XDEC_MEMVIEW(&__pyx_v__rows, 1);
  __PYX_INC_MEMVIEW(&__pyx_t_9, 0);
  __pyx_v__rows = __pyx_t_9;
  __PYX_XDEC_MEMVIEW(&__pyx_v__cols, 1);
  __PYX_INC_MEMVIEW(&__pyx_t_9, 0);
  __pyx_v__cols = __pyx_t_9;
  __PYX_XDEC_MEMVIEW(&__pyx_v__values, 1);
  ...
  /* "implicit/_nearest_neighbours.pyx":110
 * 
 *     _rows = _cols = _values = None
 *     rows.resize(current)             # <<<<<<<<<<<<<<
 *     cols.resize(current)
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_rows, __pyx_n_s_resize); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 110, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_current); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 110, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_3 = NULL;
  ...
  if (!__pyx_t_3) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_8); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 110, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_GOTREF(__pyx_t_2);
  } else {
    #if CYTHON_FAST_PYCALL
  ...
  /* "implicit/_nearest_neighbours.pyx":111
 *     _rows = _cols = _values = None
 *     rows.resize(current)
 *     cols.resize(current)             # <<<<<<<<<<<<<<
 *     values.resize(current)
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_cols, __pyx_n_s_resize); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 111, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_current); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 111, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_8 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_1))) {
  ...
  /* "implicit/_nearest_neighbours.pyx":112
 *     rows.resize(current)
 *     cols.resize(current)
 *     values.resize(current)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_values, __pyx_n_s_resize); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_current); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_1))) {
  ...
  if (!__pyx_t_7) {
    ...
    #endif
    {
      ...
      __pyx_t_3 = 0;
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_8, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 112, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    }
  }
  ...
  /* "implicit/_nearest_neighbours.pyx":114
 *     values.resize(current)
 * 
 *     return scipy.sparse.coo_matrix((values, (rows, cols)), shape=(item_count, item_count))             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_scipy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_sparse); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_coo_matrix); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_item_count); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_item_count); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_32 = PyTuple_New(2); if (unlikely(!__pyx_t_32)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_32);
  __Pyx_GIVEREF(__pyx_t_3);
  PyTuple_SET_ITEM(__pyx_t_32, 0, __pyx_t_3);
  __Pyx_GIVEREF(__pyx_t_7);
  PyTuple_SET_ITEM(__pyx_t_32, 1, __pyx_t_7);
  __pyx_t_3 = 0;
  __pyx_t_7 = 0;
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_shape, __pyx_t_32) < 0) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_32); __pyx_t_32 = 0;
  __pyx_t_32 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_1, __pyx_t_8); if (unlikely(!__pyx_t_32)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_32);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_item_indptr, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_item_indices, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_item_data, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_user_indptr, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_user_indices, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_user_data, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "implicit._nearest_neighbours.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "implicit._nearest_neighbours.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "implicit._nearest_neighbours.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "implicit._nearest_neighbours._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Users_ben_code_implicit_implici, __pyx_k_Users_ben_code_implicit_implici, sizeof(__pyx_k_Users_ben_code_implicit_implici), 0, 0, 1, 0},
  {&__pyx_n_s_ValueError, __pyx_k_ValueError, sizeof(__pyx_k_ValueError), 0, 0, 1, 1},
  {&__pyx_n_s_all_pairs_knn, __pyx_k_all_pairs_knn, sizeof(__pyx_k_all_pairs_knn), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_heap_order, __pyx_k_heap_order, sizeof(__pyx_k_heap_order), 0, 0, 1, 1},
  {&__pyx_n_s_i, __pyx_k_i, sizeof(__pyx_k_i), 0, 0, 1, 1},
  {&__pyx_n_s_id, __pyx_k_id, sizeof(__pyx_k_id), 0, 0, 1, 1},
  {&__pyx_n_s_implicit__nearest_neighbours, __pyx_k_implicit__nearest_neighbours, sizeof(__pyx_k_implicit__nearest_neighbours), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_item_indptr, __pyx_k_item_indptr, sizeof(__pyx_k_item_indptr), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_user_indptr, __pyx_k_user_indptr, sizeof(__pyx_k_user_indptr), 0, 0, 1, 1},
 ...
 *     users = items.T.tocsr()
 */
  __pyx_tuple__14 = PyTuple_Pack(32, __pyx_n_s_items, __pyx_n_s_K, __pyx_n_s_users, __pyx_n_s_item_indptr, __pyx_n_s_item_indices, __pyx_n_s_item_data, __pyx_n_s_user_indptr, __pyx_n_s_user_indices, __pyx_n_s_user_data, __pyx_n_s_item_count, __pyx_n_s_i, __pyx_n_s_u, __pyx_n_s_index1, __pyx_n_s_index2, __pyx_n_s_j, __pyx_n_s_head, __pyx_n_s_length, __pyx_n_s_w1, __pyx_n_s_w2, __pyx_n_s_sums, __pyx_n_s_nonzeros, __pyx_n_s_results, __pyx_n_s_heap_order, __pyx_n_s_result, __pyx_n_s_values, __pyx_n_s_rows, __pyx_n_s_cols, __pyx_n_s_values_2, __pyx_n_s_rows_2, __pyx_n_s_cols_2, __pyx_n_s_current, __pyx_n_s_it); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(2, 0, 32, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_ben_code_implicit_implici, __pyx_n_s_all_pairs_knn, 24, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 24, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_nearest_neighbours(void); /*proto*/
PyMODINIT_FUNC init_nearest_neighbours(void)
#else
PyMODINIT_FUNC PyInit__nearest_neighbours(void); /*proto*/
PyMODINIT_FUNC PyInit__nearest_neighbours(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__nearest_neighbours(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_nearest_neighbours", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_implicit___nearest_neighbours) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "implicit._nearest_neighbours")) {
      if (unlikely(PyDict_SetItemString(modules, "implicit._nearest_neighbours", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "implicit/_nearest_neighbours.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * import cython
 * import scipy.sparse
 */
  ...
  /* "implicit/_nearest_neighbours.pyx":3
 * import numpy as np
 * import cython
 * import scipy.sparse             # <<<<<<<<<<<<<<
 * 
 ...
 *     users = items.T.tocsr()
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8implicit_19_nearest_neighbours_1all_pairs_knn, NULL, __pyx_n_s_implicit__nearest_neighbours); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all_pairs_knn, __pyx_t_1) < 0) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init implicit._nearest_neighbours", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init implicit._nearest_neighbours");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
